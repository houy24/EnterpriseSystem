...
@WebServlet("/PersonalAttendance")
public class PersonalAttendanceServlet extends HttpServlet {
    @Override
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("============进入 PersonalAttendanceServlet============");
...
//        int last = count > 10*Integer.valueOf(limit) ? 10*Integer.valueOf(limit) : count;
        List<SignInRecord> signInRecordList =signInRecordService.selectAll();
        System.out.println("考勤记录："+signInRecordList);
