...
<head>
    ...
    <%
        ...
        System.out.println("PositionEdit.jsp => " + positionId + "," + positionName + "," + positionMoney + "," + positionDesrciption);
    %>
...
<div class="x-nav" style="margin-top: 10px;margin-left: 10px;">
        ...
        <%--            <span lay-separator>/</span>--%>
                    <span class="spanTitle"><a>岗位编辑</a> </span>
                </span>
...
<div style="margin-left: 50px;margin-top: 20px;">
    <form class="layui-form" >
        ...
        <input hidden name="positionId" value="<%=positionId%>" disabled />
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline ">
                    <input  type="text" name="positionName" lay-verify="required" style="width: 230px;"
                            autocomplete="off" class="layui-input" value="<%=positionName%>">
                </div>
            </div>
        </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline ">
                    <input  type="text" name="positionMoney" lay-verify="required|number"
                            autocomplete="off" class="layui-input" value="<%=positionMoney%>">
                </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline ">
                    <textarea name="positionDesrciption" placeholder="请输入岗位描述" class="layui-textarea"
                              lay-verify="required"><%= positionDesrciption%></textarea>
