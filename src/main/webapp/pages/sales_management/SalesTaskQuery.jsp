            ...
            table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'detail') {
                    layer.open({
                        ...
                        offset: 'auto',
                        anim: 2,
                        content: ['/pages/sales_management/MsgForSaleTask.html', 'no'], //iframe的url，no代表不显示滚动条
                    ...
                    if (isData === false) {
                        window.parent.layui.element.tabAdd('demo', {
                            title: '添加销售记录',
                            content: '<iframe data-frameid="sales-2" scrolling="auto" frameborder="0" src="/AddSalesRecord?saleTaskId=' + data.saleTaskId + '&productId=' + data.productId + '" style="width:100%;height:99%;"></iframe>',
                            id: 'sales-2'
                        })
                        window.parent.layui.element.tabChange('demo', 'sales-2');  //跳转到该tab
                    }
