    ...
    <script>
        ...
        layui.use('table', function(){
            ...
            tables = table.render({
                elem: '#test'
                ,id:'test'
                ,url:'${pageContext.request.contextPath}/PersonalDepartment_information'
                ,page:true
                ,limit: 10
                ,toolbar: '#toolbarDemo' //开启头部工具栏，并为其绑定左侧模板
                ,title: '用户数据表'
                ,cols: [[
                    {field:'departmentId', title:'部门编号', width:200, fixed: 'left', align: 'center'}
                    ,{field:'departmentName', title:'部门名称', width:100, fixed: 'left', align: 'center'}
                    ,{field:'departmentDesrciption', title:'部门描述', width:500, fixed: 'left', align: 'center'}
            ...
            table.on('tool(test)', function(obj){
                ...
                if (obj.event === 'check'){
                    ...
                    $("#departmentDesrciption").val(data.departmentDesrciption);
                }else if (obj.event === 'change'){
                    var popBox = document.getElementById("changePopup");
                    var popLayer = document.getElementById("change");
                    popBox.style.display = "block";
                    popLayer.style.display = "block";
                    $("#departmentUp").val(data.departmentId);
                    $("#departmentNameUp").val(data.departmentName);
                    $("#departmentDesrciptionUp").val(data.departmentDesrciption);
                }else{
                    layer.confirm('真的删除行么', function(index){
                        $.ajax({
                            url: "${pageContext.request.contextPath}/PersonalDepartment_informationDel",
                            data:{
        ...
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd class="layui-this"><a href="${pageContext.request.contextPath}/PersonalDepartment_informationJup">增删改查部门信息</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
    ...
    <div>
        ...
        <div class="vehiclePopup" id="detailedPopup">
            ...
            <div class="departmentId">
                <input type="text" value="部门编号：" class="HeadInput">
                <input type="text" id="department" class="ContextInput">
            </div>
            <div class="departmentUserName">
                <input type="text" value="部门名称：" class="HeadInput">
                <input type="text" id="departmentName" class="ContextInput">
            </div>
            <div class="departmentDesrciption">
                <input type="text" value="部门描述：" class="HeadInput">
                <textarea id="departmentDesrciption" style="width: 200px;height: 100px;font-size: 20px"></textarea>
            </div>
        </div>
    </div>
    <div>
        ...
        <div class="vehiclePopup" id="changePopup">
            ...
            <div class="departmentId">
                <input type="text" value="部门编号：" class="HeadInput">
                <input type="text" id="departmentUp" class="ContextInput">
            </div>
            <div class="departmentUserName">
                <input type="text" value="部门名称：" class="HeadInput">
                <input type="text" id="departmentNameUp" class="ContextInput">
            </div>
            <div class="departmentDesrciption">
                <input type="text" value="部门描述：" class="HeadInput">
                <textarea id="departmentDesrciptionUp" style="width: 200px;height: 100px;font-size: 20px"></textarea>
            </div>
            <button class="layui-btn" style="margin-top: 100px;margin-left: 350px" onclick="updateDepartment()">确认修改</button>
        </div>
    </div>
    <div>
        ...
        <div class="vehiclePopup" id="addChangePopup">
            ...
            <div class="departmentUserName">
                <input type="text" value="部门名称：" class="HeadInput">
                <input type="text" id="addDepartmentName" class="ContextInput">
            </div>
            <div class="departmentDesrciption">
                <input type="text" value="部门描述：" class="HeadInput">
                <textarea id="addDepartmentDesrciption" style="width: 200px;height: 100px;font-size: 20px"></textarea>
            </div>
            <button class="layui-btn" style="margin-top: 100px;margin-left: 350px" onclick="addDepartment()">确认修改</button>
        </div>
    </div>
    <div class="layui-body">
        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container">
                ...
                <button class="layui-btn" style="margin-left: 600px" lay-event="addDepartment" onclick="openDepartment()">增加</button>
            </div>
        </script>
