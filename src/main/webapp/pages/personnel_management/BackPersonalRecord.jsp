    ...
    <script>
        ...
        layui.use('table', function(){
            ...
            tables = table.render({
                elem: '#test'
                ,id:'test'
                ,url:'${pageContext.request.contextPath}/PersonalRecord'
                ,page:true
                ,limit: 10
        ...
        function checkByPhone(Late) {
            tables.reload({
                url: '${pageContext.request.contextPath}/PersonalRecordLate'
                , where: {
                    Late: Late
                }
                , page: {
        ...
        function checkByName(LeaveEarly) {
            tables.reload({
                url: '${pageContext.request.contextPath}/PersonalRecordLeaveEarly'
                , where: {
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd class="layui-this"><a href="${pageContext.request.contextPath}/PersonalRecordJup">查询个人考勤记录</a></dd>
    ...
    <div class="layui-body">
        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container">
                <input type="text" class="Find Phoneinput" id="Phone" name="Phone" placeholder="查询迟到次数">
                <button class="layui-btn layui-btn-sm" lay-event="checkPhone">查询</button>
                <input type="text" class="Find Phoneinput" id="Name" name="Name" placeholder="查询早退次数">
