    ...
    <script>
        ...
        layui.use('table', function(){
            ...
            tables = table.render({
                ...
                ,title: '用户数据表'
                ,cols: [[
                    {field:'userId', title:'用户编号', width:200, fixed: 'left', align: 'center'}
                    ,{field:'userName', title:'用户姓名', width:100, fixed: 'left', align: 'center'}
                    ,{field:'userPhone', title:'用户手机号', width:150, fixed: 'left', align: 'center'}
                    ,{field:'userSex', title:'用户性别', width:50, fixed: 'left', align: 'center'}
                    ,{field:'userEmail', title:'电子邮箱', width:180, fixed: 'left', align: 'center'}
                    ,{field:'userAge', title:'用户年龄', width:50, fixed: 'left', align: 'center'}
                    ...
                    ,{field:'workAge', title:'工龄', width:80, fixed: 'left', align: 'center'}
            ...
            table.on('tool(test)', function(obj){
                ...
                if (obj.event === 'check'){
                    ...
                    document.getElementById("detailedImg").src= data.userPhoto;
                    $("#detailedId").val(data.userId);
                    $("#detailedName").val(data.userName);
                    $("#detailedUserPhone").val(data.userPhone);
                    $("#detailedSex").val(data.userSex);
                    $("#detailedEmail").val(data.userEmail);
                    $("#detailedAge").val(data.userAge);
                    $("#detailedType").val(data.userType);
                    $("#detailedDepartmentId").val(data.departmentId);
                    $("#detailedPositionId").val(data.positionId);
                    $("#detailedWorkTitleId").val(data.workTitleId);
                    $("#detailedWorkAge").val(data.workAge);
                }else if (obj.event === 'change'){
                    var popBox = document.getElementById("changePopup");
                    var popLayer = document.getElementById("change");
                    popBox.style.display = "block";
                    popLayer.style.display = "block";
                    document.getElementById("changeImg").src= data.userPhoto;
                    $("#changeId").val(data.userId);
                    $("#changeName").val(data.userName);
                    $("#changeUserPhone").val(data.userPhone);
                    $("#changeSex").val(data.userSex);
                    $("#changeEmail").val(data.userEmail);
                    $("#changeAge").val(data.userAge);
                    $("#changeType").val(data.userType);
                    $("#changeDepartmentId").val(data.departmentId);
                    $("#changePositionId").val(data.positionId);
                    $("#changeWorkTitleId").val(data.workTitleId);
                    $("#changeWorkAge").val(data.workAge);
                }else{
                    layer.confirm('真的删除行么', function(index){
                        $.ajax({
                            url: "${pageContext.request.contextPath}/Personal_informationDelete",
                            data:{
                                userId: data.userId
                            }
                        })
        ...
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd class="layui-this"><a href="${pageContext.request.contextPath}/Personnel_informationJup">人员信息删改查</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
    ...
    <div>
        ...
        <div class="vehiclePopup" id="detailedPopup">
            ...
            <div class="detailedImg">
                <img src="" class="HeadMessage" id="detailedImg" ><br>
            </div>
            <div class="detailedUserId">
                <input type="text" value="用户编号：" class="HeadInput">
                <input type="text" id="detailedId" class="ContextInput">
            </div>
            <div class="detailedUserName">
                <input type="text" value="用户姓名：" class="HeadInput">
                <input type="text" id="detailedName" class="ContextInput">
            </div>
            <div class="detailedUserPhone">
                <input type="text" value="手机号：" class="HeadInput">
                <input type="text" id="detailedUserPhone" class="ContextInput">
            </div>
            <div class="detailedUserSex">
                <input type="text" value="用户性别：" class="HeadInput">
                <input type="text" id="detailedSex" value="" class="ContextInput">
            </div>
            <div class="detailedUserEmail">
                <input type="text" value="邮箱：" class="HeadInput">
                <input type="text" id="detailedEmail" value="" class="ContextInput">
            </div>
            <div class="detailedUserAge">
                <input type="text" value="年龄：" class="HeadInput">
                <input type="text" id="detailedAge" value="" class="ContextInput">
            </div>
            <div class="detailedUserType">
                <input type="text" value="用户类型：" class="HeadInput">
                <input type="text" id="detailedType" value="" class="ContextInput">
            </div>
            <div class="detailedUserDepartmentId">
                <input type="text" value="部门编号：" class="HeadInput">
                <input type="text" id="detailedDepartmentId" value="" class="ContextInput">
            </div>
            <div class="detailedUserPositionId">
                <input type="text" value="职位编号：" class="HeadInput">
                <input type="text" id="detailedPositionId" value="" class="ContextInput">
            </div>
            <div class="detailedUserWorkTitleId">
                <input type="text" value="职称编号：" class="HeadInput">
                <input type="text" id="detailedWorkTitleId" value="" class="ContextInput">
            </div>
            <div class="detailedUserWorkAge">
                <input type="text" value="工龄：" class="HeadInput">
                <input type="text" id="detailedWorkAge" value="" class="ContextInput">
            </div>
        </div>
    </div>
    <div>
        ...
        <div class="vehiclePopup" id="changePopup">
            ...
            <p class="H1_title">详细信息</p>
            <div class="detailedImg">
                <img src="" class="HeadMessage" id="changeImg" ><br>
            </div>
            <div class="detailedUserId">
                <input type="text" value="用户编号：" class="HeadInput">
                <input type="text" id="changeId" class="ContextInput">
            </div>
            <div class="detailedUserName">
                <input type="text" value="用户姓名：" class="HeadInput">
                <input type="text" id="changeName" class="ContextInput">
            </div>
            <div class="detailedUserPhone">
                <input type="text" value="手机号：" class="HeadInput">
                <input type="text" id="changeUserPhone" class="ContextInput">
            </div>
            <div class="detailedUserSex">
                <input type="text" value="用户性别：" class="HeadInput">
                <input type="text" id="changeSex" value="" class="ContextInput">
            </div>
            <div class="detailedUserEmail">
                <input type="text" value="邮箱：" class="HeadInput">
                <input type="text" id="changeEmail" value="" class="ContextInput">
            </div>
            <div class="detailedUserAge">
                <input type="text" value="年龄：" class="HeadInput">
                <input type="text" id="changeAge" value="" class="ContextInput">
            </div>
            <div class="detailedUserType">
                <input type="text" value="用户类型：" class="HeadInput">
                <input type="text" id="changeType" value="" class="ContextInput">
            </div>
            <div class="detailedUserDepartmentId">
                <input type="text" value="部门编号：" class="HeadInput">
                <input type="text" id="changeDepartmentId" value="" class="ContextInput">
            </div>
            <div class="detailedUserPositionId">
                <input type="text" value="职位编号：" class="HeadInput">
                <input type="text" id="changePositionId" value="" class="ContextInput">
            </div>
            <div class="detailedUserWorkTitleId">
                <input type="text" value="职称编号：" class="HeadInput">
                <input type="text" id="changeWorkTitleId" value="" class="ContextInput">
            </div>
            <div class="detailedUserWorkAge">
                <input type="text" value="工龄：" class="HeadInput">
                <input type="text" id="changeWorkAge" value="" class="ContextInput">
            </div>
            <button class="layui-btn" style="margin-left: 350px" onclick="updateMessage()">确认修改</button>
        </div>
    </div>
