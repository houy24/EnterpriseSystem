...
<div class="x-nav" style="margin-top: 10px;margin-left: 10px;">
        ...
        <%--            <span lay-separator>/</span>--%>
                    <span class="spanTitle"><a>税率信息增加</a> </span>
                </span>
...
<div style="margin-left: 50px;margin-top: 20px;">
    <form class="layui-form" >
        ...
        <%--税率编号，隐藏--%>
        <input hidden name="taxRateId" value="" disabled />
...
<script>
    ...
    layui.use('form', function(){
        ...
        form.on('submit(myForm)', function(data){
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/addTaxRate",
                data: {     // 表单数据
                    // taxRateId : data.field.taxRateId, // 无
                    money : data.field.money,
                    rate : data.field.rate,
                    // quicklyReduce : data.field.quicklyReduce, // 无
                },
                dataType: 'json',
