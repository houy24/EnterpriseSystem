...
<div class="x-nav" style="margin-top: 10px;margin-left: 10px;">
    ...
    <%--            <span lay-separator>/</span>--%>
                <span class="spanTitle"><a>查询员工岗位</a> </span>
            </span>
...
<script>
    ...
    layui.use('form', function(){
        ...
        form.on('submit(myForm)', function(data){
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/queryPosition",
                data: {     // 表单数据
                ...
                success: function (result) {
                    ...
                    if (result.check.toString() === "false") {
                        ...
                        console.log(obj.nowPosition);

                        let nowPosition = obj.nowPosition;
                        let nowUserData = obj.nowUserData;

                        layer.alert("查询成功！ </br>" + "员工：" + nowUserData.userName
                            + ",员工手机号：" + nowUserData.userPhone
                            + ",员工岗位：" + nowPosition.positionName
                            + ",岗位工资：" + nowPosition.positionMoney);
