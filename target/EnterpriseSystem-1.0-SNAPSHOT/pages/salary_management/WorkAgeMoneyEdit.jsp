...
<head>
    ...
    <%
        String preWorkAge = request.getParameter("preWorkAge");
        String baseAgeMoney = request.getParameter("baseAgeMoney");

        System.out.println("WorkAgeMoneyEdit.jsp => " + preWorkAge + "," + baseAgeMoney);
    %>
...
<div class="x-nav" style="margin-top: 10px;margin-left: 10px;">
        ...
        <%--            <span lay-separator>/</span>--%>
                    <span class="spanTitle"><a>工龄信息编辑</a> </span>
                </span>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline ">
                    <input  type="text" name="workAge" lay-verify="required|number" style="width: 230px;"
                            autocomplete="off" class="layui-input" value="<%=preWorkAge%>">
                </div>
            </div>
        </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline ">
                    <input  type="text" name="baseAgeMoney" lay-verify="required|number"
                            autocomplete="off" class="layui-input" value="<%=baseAgeMoney%>">
                </div>
