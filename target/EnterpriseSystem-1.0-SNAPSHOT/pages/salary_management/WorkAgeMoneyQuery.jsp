...
<div class="x-nav" style="margin-top: 10px;margin-left: 10px;">
    ...
    <%--            <span lay-separator>/</span>--%>
                <span class="spanTitle"><a>查询员工工龄</a> </span>
            </span>
...
<script>
    ...
    layui.use('form', function(){
        ...
        form.on('submit(myForm)', function(data){
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/queryWorkAgeMoney",
                data: {     // 表单数据
                ...
                success: function (result) {
                    ...
                    if (result.check.toString() === "false") {
                        ...
                        console.log(obj.nowWorkAgeMoney);
                        ...
                        let nowWorkAgeMoney = obj.nowWorkAgeMoney;
                        ...
                        layer.alert("查询成功！ </br>" + "员工：" + nowUserData.userName
                            ...
                            + ",员工工龄：" + nowWorkAgeMoney.workAge
                            + ",工龄基础工资：" + nowWorkAgeMoney.baseAgeMoney);
