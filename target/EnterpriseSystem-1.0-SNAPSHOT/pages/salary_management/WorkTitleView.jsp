...
<body>
    ...
    <%--            <span lay-separator>/</span>--%>
                <span class="spanTitle"><a>职称列表</a> </span>
            </span>
    ...
    <div style="margin-left: 20px;margin-top: 20px;">
        <%--职称表格--%>
        <table class="layui-hide" id="WorkTitleList"  lay-filter="demo"></table>
...
<script>
    ...
    layui.use(['layer', 'table', 'element'], function(){
        ...
        var tableIns = table.render({
            elem: '#WorkTitleList'
            ,height: 540 //设置表的高度
            ,url: '${pageContext.request.contextPath}/getAllWorkTitle' //数据接口
            ,title: '职称表'
            ,page: true //开启分页
            ,limits: [5,10,15,20]
            ,limit: 5
            ...
            ,cols: [[ //表头
                ...
                //职称表（职称编号，职称名称，职称工资）
                //work_title（workTitleId,workTitleName,workTitleMoney）

                {type:'checkbox'},  //复选框

                {field: 'workTitleId', width: 255, align:'center',  title: 'ID', sort: true,
                                style: 'font-size:18px;'} //职称编号
                ,{field: 'workTitleName',width:329, align:'center', title: '职称名称',
                                style: 'font-size:18px;'}
                ,{field: 'workTitleMoney',width:388, align:'center',title: '职称工资',
                                style: 'font-size:18px;'}
