...
<div class="x-nav" style="margin-top: 10px;margin-left: 10px;">
        ...
        <%--            <span lay-separator>/</span>--%>
                    <span class="spanTitle"><a>工龄工资管理</a> </span>
        <%--            <span lay-separator>/</span>--%>
                    <span class="spanTitle"><a>工龄列表</a> </span>
                </span>
...
<div style="margin-left: 20px;margin-top: 20px;">
    <%--工龄工资表格--%>
    <table class="layui-hide" id="WorkAgeMoneyList"  lay-filter="demo"></table>
...
<script>
    ...
    layui.use(['layer', 'table', 'element'], function(){
        ...
        var tableIns = table.render({
            elem: '#WorkAgeMoneyList'
            ,height: 540 //设置表的高度
            ,url: '${pageContext.request.contextPath}/getAllWorkAgeMoney' //数据接口
            ,title: '工龄工资表'
            ,page: true //开启分页
            ,limits: [5,10,15,20]
            ,limit: 5
            ...
            ,cols: [[ //表头
                ...
                //工龄工资表（工龄年数，每年基础加成）
                //work_age_money(workAge,baseAgeMoney)

                {type:'checkbox'},  //复选框

                {field: 'workAge', width: 547, align:'center',  title: '工龄', sort: true,
                    style: 'font-size:18px;'} //工龄年数
                ,{field: 'baseAgeMoney',width: 341, align:'center', title: '基础补贴工资',
                    style: 'font-size:18px;'}   // 每年基础加成

                ,{title: '操作',/*fixed: 'right',*/ width: 341, align:'center', toolbar: '#barDemo',
        ...
        table.on('toolbar(demo)', function(obj){
            ...
            if (layEvent === 'add') { // 增加
                ...
                var index = layer.open({
                    ...
                    offset: '9%',
                    //加载编辑页面的弹出层
                    content: 'WorkAgeMoneyAdd.jsp',
                    btn: '关闭',
                    skin: 'editLayer',   // 自定义样式
                    yes:function(){     // 点关闭按钮的话，刷新页面
                        tableIns.reload("demo",{
                            url:'${pageContext.request.contextPath}/getAllWorkAgeMoney'
                        });
                        layer.closeAll();
                    },
                    btnAlign: 'c', //按钮居中
        ...
        table.on('tool(demo)', function(obj){ //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'del')
            {
                layer.confirm('确定要删除么', function(index){
                    ...
                    //向服务端发送删除指令
                    $.ajax({
                        url: "${pageContext.request.contextPath}/deleteWorkAgeMoney", //（？）
                        data: {  // 数据
                ...
                var index = layer.open({
                    ...
                    offset: '9%',
                    //加载编辑页面的弹出层
                    content: 'WorkAgeMoneyEdit.jsp?' + 'preWorkAge=' + data.workAge
                        + '&' +'baseAgeMoney=' + data.baseAgeMoney,
                    btn: '关闭',
                    skin: 'editLayer',   // 自定义样式
                    yes:function(){
                        tableIns.reload("demo",{
