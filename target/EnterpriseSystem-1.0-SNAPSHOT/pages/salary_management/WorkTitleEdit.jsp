...
<%
    ...
    System.out.println("WorkTitleView.jsp => " + workTitleId + "," + workTitleName + "," + workTitleMoney);
...
<div class="x-nav" style="margin-top: 10px;margin-left: 10px;">
        ...
        <%--            <span lay-separator>/</span>--%>
                    <span class="spanTitle"><a>职称编辑</a> </span>
                </span>
...
<div style="margin-left: 50px;margin-top: 20px;">
    <form class="layui-form" >
        ...
        <input hidden name="workTitleId" value="<%=workTitleId%>" disabled />
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline ">
                    <input  type="text" name="workTitleName" lay-verify="required" style="width: 230px;"
                            autocomplete="off" class="layui-input" value="<%=workTitleName%>">
                </div>
            </div>
        </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline ">
                    <input  type="text" name="workTitleMoney" lay-verify="required|number"
                            autocomplete="off" class="layui-input" value="<%=workTitleMoney%>">
                </div>
...
<script>
    ...
    layui.use('form', function(){
        ...
        form.on('submit(myForm)', function(data){
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/saveWorkTitle",
                data: {     // 表单数据
                    workTitleId : data.field.workTitleId,
                    workTitleName : data.field.workTitleName,
                    workTitleMoney : data.field.workTitleMoney,
                },
                dataType: 'json',
