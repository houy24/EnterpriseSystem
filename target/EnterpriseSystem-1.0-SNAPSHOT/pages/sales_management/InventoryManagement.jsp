            ...
            table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'detail') {
                    layer.open({
                        ...
                        offset: 'auto',
                        anim: 2,
                        content: ['/pages/sales_management/MsgForAssignSalesTasks.jsp', 'yes'], //iframe的url，no代表不显示滚动条
                    ...
                    dropdown.render({
                        ...
                        , click: function (menudata) {
                            if (menudata.id === 'del') {
                                ...
                                //向服务端发送删除指令
                                $.ajax({
                                    url:'${pageContext.request.contextPath}/deleteOneProductWarehouse',
                                    data:{
                                ...
                                layer.open({
                                    ...
                                    offset: 'auto',
                                    anim: 2,
                                    content: ['/pages/sales_management/MsgForInventoryManagement.jsp', 'yes'], //iframe的url，no代表不显示滚动条
                                    success: function(layero, index){
                                        let body = layer.getChildFrame('body', index);
